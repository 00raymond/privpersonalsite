        ...
        <div className="rounded-xl border border-slate-800 bg-gradient-to-l from-slate-700 to-slate-800 px-8 py-10 shadow-2xl text-left max-w-4xl w-screen mb-4 overflow-y-auto">
            <ol className=" relative border-s border-gray-200 dark:border-gray-700">
                ...
                <li className="mb-10 ms-4">
                    ...
                    <div className={"flex space-x-1 items-baseline"}>
                        <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Accelerated Computing in CUDA C/C++ Certification</h3>
                        <p className="text-md font-normal italic text-gray-900 dark:text-gray-300">NVIDIA Deep Learning Institute</p>
                    </div>
                    <p className=" font-normal text-gray-500 dark:text-gray-400"></p>
                    <p className=" font-bold text-gray-500 dark:text-gray-400 language-gradient">CUDA Toolkit, C/C++, Nsight Systems</p>
                </li>
                <li className="mb-10 ms-4">
                    <div className="absolute w-3 h-3 bg-gray-200 rounded-full mt-1.5 -start-1.5 border border-white dark:border-gray-900 dark:bg-gray-700"></div>
